...
export const fetchDatas = async () => {
  try {
    ...
    const response = await axios.get('http://100.114.201.121:8093/api/product/v1/getProductInCompany', {
      headers: {
...
export const createData = async (data) => {
  try {
    ...
    const response = await axios.post('http://100.114.201.121:8093/api/position/v1/creatPositionInCompany', data, {
      headers: {
        Authorization: `Bearer ${token}`,
    ...
    const response = await axios.get(`http://100.114.201.121:8093/api/user/v1/details/${userId}`, {
      ...
      export const fetchDatas = async () => {
        try {
          ...
          // Make the API call with the authorization header
          const response = await axios.get('http://100.114.201.121:8093/api/farm/v1/getFarmInCompany', {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          });
