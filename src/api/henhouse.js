...
export const fetchDatas = async () => {
  try {
    ...
    const response = await axios.get('http://100.114.201.121:8093/api/henHouse/v1/getHenHouseInMyCompany', {
      headers: {
...
export const createData = async (data) => {
  try {
    ...
    const response = await axios.post('http://100.114.201.121:8093/api/henhouse/v1/creatHenhouseInCompany', data, {
      headers: {
        Authorization: `Bearer ${token}`,
